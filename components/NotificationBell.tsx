...
type InboxItem={id:string;title:string;body:string;category:string;status:string;priority:string;action_label:string|null;action_url:string|null;created_at:string};
