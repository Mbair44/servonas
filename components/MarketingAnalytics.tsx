...
export function MarketingAnalytics(){
 ...
 useEffect(()=>{if(platform())setConsent(localStorage.getItem(CONSENT));},[]);
 useEffect(()=>{
  if(consent!=="granted"||!platform())return;
 ...
 if(typeof window==="undefined"||!platform()||consent)return null;
