...
export function EmployeeManagementConsole({businessSlug,employees,roles,canEdit,createAction,inviteAction,deactivateAction}:{
 businessSlug:string;employees:Employee[];roles:Role[];canEdit:boolean;
