...
alter table public.business_website_onboarding_states
 ...
 check(source in('pest-control-website','car-detailing-website','hvac-website','plumbing-website','landscaping-website','cleaning-website','floral-event-website'));
...
begin
 ...
 if p_source not in('pest-control-website','car-detailing-website','hvac-website','plumbing-website','landscaping-website','cleaning-website','floral-event-website') then raise exception 'Invalid acquisition source' using errcode='22023';end if;
