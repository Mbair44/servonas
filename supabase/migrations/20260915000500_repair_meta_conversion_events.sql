...
-- Production repair for the server-only Meta CAPI idempotency ledger.
...
comment on table public.meta_conversion_events is 'Server-side Meta Conversions API delivery ledger for event_id deduplication between browser Pixel and CAPI events.';
