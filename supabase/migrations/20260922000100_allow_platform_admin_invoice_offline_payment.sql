-- Platform-admin requests use the server-side service-role client after the
-- application has already authorized workspace access. Keep direct staff RPC
-- calls constrained by their authenticated business membership.
begin;
