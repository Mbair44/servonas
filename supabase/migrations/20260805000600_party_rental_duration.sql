...
alter table public.booking_settings add constraint booking_settings_rental_duration_check check(rental_duration_minutes between 30 and 1440 and rental_duration_minutes % 30 = 0);
