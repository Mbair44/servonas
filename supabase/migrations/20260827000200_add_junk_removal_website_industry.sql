...
alter table public.businesses
  drop constraint if exists businesses_industry_profile_check;
alter table public.businesses
  add constraint businesses_industry_profile_check
  check(industry_profile is null or industry_profile in ('pest_control','lawn_care','pool_service','hvac','plumbing','electrical','junk_removal','party_rental','equipment_rental','other'));
...
begin
 ...
 if p_industry_profile not in ('pest_control','lawn_care','pool_service','hvac','plumbing','electrical','junk_removal','party_rental','equipment_rental','other') then raise exception 'Invalid industry profile' using errcode='22023';end if;
 ...
 v_defaults:=case p_industry_profile
  ...
  when 'junk_removal' then '{"service_name":"Junk removal quote","duration_minutes":90,"recurring_allowed":false}'::jsonb
...
alter table public.business_website_onboarding_states
 ...
 check(source in('pest-control-website','car-detailing-website','hvac-website','plumbing-website','landscaping-website','cleaning-website','powerwashing-website','junk-removal-website','floral-event-website','event-party-rentals-website'));
...
alter table public.website_builder_drafts
  add constraint website_builder_drafts_source_check check (
    source in (
      'pest-control-website','car-detailing-website','hvac-website','plumbing-website','landscaping-website','cleaning-website','powerwashing-website','junk-removal-website','floral-event-website','event-party-rentals-website'
    )
  );
...
begin
 ...
 if p_source not in('pest-control-website','car-detailing-website','hvac-website','plumbing-website','landscaping-website','cleaning-website','powerwashing-website','junk-removal-website','floral-event-website','event-party-rentals-website') then raise exception 'Invalid acquisition source' using errcode='22023';end if;
