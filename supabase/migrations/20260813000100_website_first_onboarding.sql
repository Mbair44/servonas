...
create or replace function public.create_website_first_workspace(p_name text,p_slug text,p_email text,p_phone text,p_city text,p_state text,p_service_area text,p_description text,p_services text[],p_source text,p_service_model text)
...
begin
 ...
 insert into public.business_website_onboarding_states(business_id,source,current_step,selected_services,updated_by) values(v_business.id,p_source,'style',coalesce(p_services,'{}'),v_user);
...
revoke all on function public.create_website_first_workspace(text,text,text,text,text,text,text,text,text[],text,text) from public;
grant execute on function public.create_website_first_workspace(text,text,text,text,text,text,text,text,text[],text,text) to authenticated;
