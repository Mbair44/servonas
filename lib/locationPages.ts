...
export async function generateLocationPage(input:{source:LocationPageSource;existingPages:Array<{city:string;h1:string;hero_copy:string;sections:LocationPageSection[];faqs:LocationPageFaq[]}>}){
