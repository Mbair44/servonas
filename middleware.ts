...
const shouldUseBarePublicShell=(path:string)=>path.startsWith("/book/")||path==="/booking"||path.startsWith("/booking/")||path.startsWith("/manage-booking/")||path.startsWith("/sites/");
