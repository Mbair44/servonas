...
const settingsUrl=(slug:string,kind:"success"|"error",message:string)=>`${stripeConnectBaseUrl()}/app/${encodeURIComponent(slug)}/settings/billing?${kind}=${encodeURIComponent(message)}#payments`;
