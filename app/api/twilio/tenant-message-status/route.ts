...
export async function POST(request:Request){
 ...
 try{await recordTenantStatusCallback({businessId:account.business_id,accountSid,messageSid,status:messageStatus||"accepted",errorCode:params.get("ErrorCode")});}catch{}
