...
import {domainRetailPrice,getVercelDomainQuote,vercelRegistrarConfigured,vercelStandardDomainMaximumPrice} from "@/lib/vercelDomains";
...
export async function POST(request:Request){
 ...
 try{
  ...
  return NextResponse.json({domain:quote.domain,available:quote.available,premium,purchasePrice:domainRetailPrice(quote.purchasePrice),renewalPrice:domainRetailPrice(quote.renewalPrice),currency:"USD",years:quote.years},{headers:{"Cache-Control":"no-store"}});
 }catch(error){
