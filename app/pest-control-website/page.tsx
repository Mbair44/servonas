...
export const metadata:Metadata={
 ...
 description:"We'll build your pest control website and cover one standard domain for the first year. Get online booking and business tools with Servonas.",
...
export default async function PestControlWebsitePage({searchParams}:{searchParams:Promise<Record<string,string|string[]|undefined>>}){
 ...
 return <main className="pcw-page"><ServerMarketingLandingAttribution source="pest-control-website" path="/pest-control-website" searchParams={params}/>
  ...
  <section className="pcw-pilot"><div className="sv-container"><span aria-hidden="true">★</span><div><h2>A limited Servonas pilot offer</h2><p>We&apos;ll build your website and cover one standard domain registration for the first year. Premium domains are not included, and renewal after the first year is the business owner&apos;s responsibility.</p></div></div></section>
