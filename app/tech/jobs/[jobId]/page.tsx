...
import { addTechnicianInvoiceItem,addTechnicianNote,generateTechnicianInvoice,presentTechnicianInvoice,recordTechnicianPayment, removeTechnicianPhoto, transitionTechnicianJob, uploadTechnicianPhoto } from "../../actions";
...
export default async function TechnicianJobDetail({ params, searchParams }: {
  ...
  if (!job) notFound();
  const [{ data: history }, { data: notes }, { data: photoRows },{data:priceItems},{data:invoice},{data:payments}] = await Promise.all([
