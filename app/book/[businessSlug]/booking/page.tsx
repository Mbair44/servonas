...
export default async function PublicBookingCheckoutPage({params,searchParams}:{params:Promise<{businessSlug:string}>;searchParams:Promise<{embed?:string;sv_at?:string;cartState?:string;dateState?:string}>}){
