...
export default async function Page({searchParams}:{searchParams:Promise<Record<string,string|string[]|undefined>>}){
 ...
 const site:BusinessSiteData={
  ...
  services:[],
  rentalItems:[
   {id:"1",name:"Palm Breeze Bounce House",category:"Inflatables",description:"A colorful all-ages bounce house for birthdays, school events, and neighborhood parties.",dailyPriceCents:24900,imageUrl:null,standardRentalHours:24,multiDayMessage:"Discounted extra-day pricing available."},
   {id:"2",name:"40 White Folding Chairs",category:"Tables and Chairs",description:"Clean, event-ready seating for ceremonies, backyard celebrations, and school gatherings.",dailyPriceCents:6800,imageUrl:null,standardRentalHours:24,multiDayMessage:null},
   {id:"3",name:"8-Foot Banquet Tables",category:"Tables and Chairs",description:"Commercial banquet tables ideal for food service, gifts, crafts, and event seating layouts.",dailyPriceCents:1400,imageUrl:null,standardRentalHours:24,multiDayMessage:null},
   {id:"4",name:"20x20 High-Peak Tent",category:"Tents and Canopies",description:"A premium canopy setup for weddings, corporate events, shade coverage, and outdoor parties.",dailyPriceCents:39500,imageUrl:null,standardRentalHours:24,multiDayMessage:"Ask about multi-day event packages."},
   {id:"5",name:"Yard Party Game Set",category:"Games and Add-ons",description:"Add oversized party games for family events, company picnics, and school celebrations.",dailyPriceCents:5900,imageUrl:null,standardRentalHours:24,multiDayMessage:null},
   {id:"6",name:"LED Cocktail Tables",category:"Wedding and Event Decor",description:"Modern illuminated cocktail tables that add style to evening receptions and private events.",dailyPriceCents:3200,imageUrl:null,standardRentalHours:24,multiDayMessage:null},
  ],
