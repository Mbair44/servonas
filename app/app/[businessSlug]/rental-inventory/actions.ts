...
async function values(supabase:SupabaseClient,businessId:string,data:FormData){
 ...
 const useOverride=data.get("usePricingOverride")==="on",overrideType=text(data,"additionalDayPricingTypeOverride"),overrideDiscount=text(data,"additionalDayDiscountPercentOverride"),overrideFlat=text(data,"additionalDayFlatRateOverride"),overrideHours=text(data,"standardRentalHoursOverride"),overrideMax=text(data,"maxRentalDaysOverride");
