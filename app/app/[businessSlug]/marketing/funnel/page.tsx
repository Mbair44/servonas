...
const checkoutSteps:[string,string][]=[["checkout_started","Checkout started"],["customer_info_completed","Customer info completed"],["delivery_address_completed","Delivery address completed"],["terms_accepted","Terms accepted"],["payment_cta_clicked","Payment CTA clicked"],["payment_started","Payment started"],["payment_succeeded","Payment succeeded"],["booking_confirmed","Booking confirmed"]];
