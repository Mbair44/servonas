...
export default async function EditInvoice({params}:{params:Promise<{businessSlug:string;invoiceId:string}>}){
  ...
  const [{data:invoice},{data:lines},{data:fees},{data:customers},{data:locations},{data:jobs},{data:priceItems},{data:billingSettings},{data:paymentAccount}]=await Promise.all([
