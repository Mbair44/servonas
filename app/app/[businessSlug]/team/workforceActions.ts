...
const employeePayload=(formData:FormData,userId:string)=>{
 ...
 const payload={first_name:firstName,last_name:lastName,preferred_name:preferredName,legal_name:normalizeOptional(formData.get("legalName")),email:normalizeOptional(formData.get("email"))?.toLowerCase()??null,phone:normalizeOptional(formData.get("phone")),secondary_phone:normalizeOptional(formData.get("secondaryPhone")),address_line_1:normalizeOptional(formData.get("addressLine1")),address_line_2:normalizeOptional(formData.get("addressLine2")),city:normalizeOptional(formData.get("city")),state:normalizeOptional(formData.get("state")),postal_code:normalizeOptional(formData.get("postalCode")),country:normalizeOptional(formData.get("country"))??"US",emergency_contact_name:normalizeOptional(formData.get("emergencyContactName")),emergency_contact_phone:normalizeOptional(formData.get("emergencyContactPhone")),emergency_contact_relationship:normalizeOptional(formData.get("emergencyContactRelationship")),employee_number:normalizeOptional(formData.get("employeeNumber")),job_title:normalizeOptional(formData.get("jobTitle")),employee_type:normalizeOptional(formData.get("employeeType")),employment_status:employmentStatus,manager_employee_id:normalizeOptional(formData.get("managerEmployeeId")),profile_photo_url:normalizeOptional(formData.get("profilePhotoUrl")),hire_date:normalizeOptional(formData.get("hireDate")),termination_date:terminationDate,notes:normalizeOptional(formData.get("notes")),is_active:employmentStatus==="active",updated_by:userId};
