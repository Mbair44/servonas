...
export default async function TeamPage({params,searchParams}:{params:Promise<{businessSlug:string}>;searchParams:Promise<Record<string,string|undefined>>}){
 ...
 const [{data:employees,error},{data:roles},{data:workIntervals},{data:exceptions},{data:jobs},{data:technicians},{data:qualifications},{data:capacityProfiles},{data:features}]=await Promise.all([
